...
import imageStyles from "../../Ui/Images/ImageComponent.module.css";
...
function LargeButton({ imageName, imageAlt, title, onClick }) {
  return (
    // 2. A prop 'onClick' é aplicada diretamente na div principal,
    // tornando todo o container clicável.
    <div className={styles.container} onClick={onClick}>
      <ImageComponent name={imageName} alt={imageAlt} className={imageStyles.person} />
